...
<svg width="920" height="480" viewBox="0 0 920 480" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="475" cy="240" r="11" fill="#9b59b6">
    <animate attributeName="opacity" values="0.3;0.3;1;0.3;0.3" dur="24s" repeatCount="indefinite" keyTimes="0;0.44;0.45;0.46;1"/>
  </circle>
  <text x="475" y="244" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">5</text>
  ...
  <circle r="4" fill="#1abc9c" opacity="0">
    <animate attributeName="opacity" values="0;0;1;1;0;0" keyTimes="0;0.37;0.375;0.525;0.53;1" dur="24s" repeatCount="indefinite"/>
    <animateMotion path="M 560 300 L 560 330 L 80 330 L 80 310" keyTimes="0;0.37;0.53;1" keyPoints="0;0;1;1" dur="24s" repeatCount="indefinite" calcMode="linear"/>
  </circle>
  ...
  <circle cx="705" cy="240" r="11" fill="#e74c3c">
    <animate attributeName="opacity" values="0.3;0.3;1;0.3;0.3" dur="24s" repeatCount="indefinite" keyTimes="0;0.66;0.67;0.68;1"/>
  </circle>
  <text x="705" y="244" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">7</text>
  ...
  <circle r="4" fill="#95a5a6" opacity="0">
    <animate attributeName="opacity" values="0;0;1;1;0;0" keyTimes="0;0.59;0.595;0.745;0.75;1" dur="24s" repeatCount="indefinite"/>
    <animateMotion path="M 595 300 L 595 370 L 160 370 L 160 310" keyTimes="0;0.59;0.75;1" keyPoints="0;0;1;1" dur="24s" repeatCount="indefinite" calcMode="linear"/>
  </circle>
